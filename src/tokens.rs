#[macro_export]
/// This is a macro used internally by implot-rs to create StackTokens
...
macro_rules! create_token {
    (
        ...
        #[must_use]
        $(#[$struct_meta])*
        pub struct $token_name<'a>(std::marker::PhantomData<&'a $crate::PlotUi<'a>>);

        impl<'a> $token_name<'a> {
            /// Creates a new token type.
            pub(crate) fn new(_: &'a $crate::PlotUi) -> Self {
